...
class XmlParser(ABCParser):
    ...
    def _parse_xml_parcel_receipient_info(self, xml_parcel: str) -> ReceipientInfo:
        ...
        return ReceipientInfo(  name=name, 
                                street=street, 
    ...
    def _parse_xml_parcel_info(self, xml_parcel: str) -> ParcelInfo:
        ...
        return ParcelInfo(  weight=weight, 
                            value=value)

    def _build_parcel_object(self, parcel_info: ParcelInfo, receipient_info: ReceipientInfo) -> Parcel:
    ...
    def get_parcels(self) -> list:
        ...
        for xml_parcel in xml_parcels:
            receipient_info = self._parse_xml_parcel_receipient_info(xml_parcel=xml_parcel)
